...
| [`algorithm`](algorithm/) | Algorithm 4.1-omp: рискованная или крупная работа через PRD с дословной целью пользователя, проверяемыми критериями, доказательствами и независимой проверкой. В комплекте extension `algorithm-guard`, которое блокирует невалидные PRD |
